...
$row2=mysqli_fetch_assoc(mysqli_query($con,"select rate from user_rating where name='".$_COOKIE['user']."' and ID='".$row['H_Id']."'"));

echo'
      <input type="range" name="points" id="points" value="'.$row2['rate'].'" min="0" max="10">
	  <input type="submit" value="submit" onClick="refresh()" class="custom">
</form>
