...
$result2=mysqli_query($con,"select * from rating where H_Id='".$hotelID."'");
$row2=mysqli_fetch_assoc($result2);
$result3=mysqli_query($con,"select Rate_count from login where Email='".$userID."'");
...
mysqli_query($con,"update rating set avgRating='".$avgRating."',TotalRate='".$updateHotelRate."',NoofUserRated='".$updateNoofUser."' where H_Id='".$hotelID."'");
mysqli_query($con,"update login set Rate_count='".$updateRatecount."' where Email='".$userID."'");
}
...
mysqli_query($con,"update rating set TotalRate='".$updateHotelRate2."',avgRating='".$avgRating2."' where H_Id='".$hotelID."'");
}
...
?>
<script>
window.location.assign("login(part2).php");
</script>
</body>
</html>